...
- [Configuring the System](#configuring-the-system)
    ...
    - [Downloading Gradel](#downloading-gradel)
    - [Installing Symfony Project](#installing-symfony-project)
    - [Getting the Database Setup](#getting-the-database-setup)
    - [Setting Up the Virtual Host](#setting-up-the-virtual-host)
    - [Creating the Docker Container for Compilation](#creating-the-docker-container-for-compilation)
    - [Configure the Web Socket to Restart on Reboot](#configure-the-web-socket-to-restart-on-reboot)
- [Cleanup](#cleanup)
...
```
This allows the web server to be run as a script on reboot
